...
namespace nyax_console
{
    ...
    {
        public static string ENCRIPTION_DECRYPTION_KEY = "Nyax_Console";
        public static string APP_NAME = System.Configuration.ConfigurationManager.AppSettings["APP_NAME"];//"Ntharene App Command Line Interface";
